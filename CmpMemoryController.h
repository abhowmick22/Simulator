...
class CmpMemoryController : public MemoryComponent {
  ...
  public:
    ...
    CmpMemoryController() {
      ...
      _rowSize = 8192;
      _rowHitLatency = 168;
      _rowConflictLatency = 408;
      _readToWriteLatency = 24;
      _writeToReadLatency = 72;
    ...
    void AddParameter(string pname, string pvalue) {
      ...
      CMP_PARAMETER_UINT("write-to-read-latency", _writeToReadLatency)
  ...
  protected:
    ...
    cycles_t ProcessRequest(MemoryRequest *request) {
      ...
      addr_t logicalRow = (request -> physicalAddress) / _rowSize;

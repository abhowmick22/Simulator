// -----------------------------------------------------------------------------
// File: CmpGenericLLC.h
// Description:
//    Implements a generic last-level cache.
// -----------------------------------------------------------------------------

#ifndef __CMP_GENERIC_LLC_H__
#define __CMP_GENERIC_LLC_H__
...
class CmpGenericLLC : public MemoryComponent {
